    ...
    <div className="flex min-h-screen items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-8 glass p-10 rounded-3xl shadow-2xl backdrop-blur-xl border border-white/40 animate-scale-in relative z-10">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-4xl font-black text-gradient">Create Account</h1>
          <p className="text-gray-600 font-medium">Start organizing your life today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500 ml-1 mt-1">Minimum 8 characters</p>
          </div>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-white/70 backdrop-blur-sm text-gray-600 rounded-full font-medium">Already have an account?</span>
          </div>
        </div>
